...
def solveKnapsack(weights, prices, capacity, index):
    ...
    if weights[index] > capacity:
        return solveKnapsack_v1(weights, prices, capacity, index + 1)
    ...
    return max(prices[index] + solveKnapsack_v1(weights, prices, capacity - weights[index], index + 1),
               solveKnapsack_v1(weights, prices, capacity, index + 1))


def knapsack(weights, prices, capacity):
    return solveKnapsack_v1(weights, prices, capacity, 0)
